...
public class SignupController {
	...
	public String signUpPost(@RequestParam(name = "planId", required = true) int planId,
			@ModelAttribute(name = PAYLOAD_MODEL_KEY_NAME) @Valid ProAccountPayload payload, ModelMap model) throws IOException {
		...
		//There are certain infor that the user doesn't set, such as profile image URL, Stripe customer id,
		// plans and roles.
